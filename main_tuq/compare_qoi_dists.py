...
"""
Script for comparing torch1d output QOI distributions between sample sets

Primarily used to compare the KL rate uncertainty model to the original 
cross section model
...
if kde:
    ...
    fig.savefig(f'../plots/kpdes_pres2.png')
else:
    fig.savefig(f'../plots/hists_full.png')
